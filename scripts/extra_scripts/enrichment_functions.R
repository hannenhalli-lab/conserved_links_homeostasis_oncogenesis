...
pathways <- readRDS("/data/timonaj/cancer_as_wound/pathways.rds")
# -
...
for(i in 1:length(species_exptype)) {
    ...
    if(length(current_species_up) == length(current_species_down)) {
        for(j in 1:length(current_species_up)) {
            current_file_path_up <- paste('/data/timonaj/cancer_as_wound/geo_degs/', current_species_up[j], sep="")
            current_file_path_down <- paste('/data/timonaj/cancer_as_wound/geo_degs/', current_species_down[j], sep="")
...
for(i in 1:length(immediate_species_exptype)) {
    ...
    if(length(current_species_up) == length(current_species_down)) {
        for(j in 1:length(current_species_up)) {
            current_file_path_up <- paste('/data/timonaj/cancer_as_wound/immediate_genes/', current_species_up[j], sep="")
            current_file_path_down <- paste('/data/timonaj/cancer_as_wound/immediate_genes/', current_species_down[j], sep="")
...
for(i in 1:length(exptype)) {
    ...
    if(length(current_exp_up) == length(current_exp_down)) {
        for(j in 1:length(current_exp_up)) {
            current_file_path_up <- paste('/data/timonaj/cancer_as_wound/geo_degs/', current_exp_up[j], sep="")
            current_file_path_down <- paste('/data/timonaj/cancer_as_wound/geo_degs/', current_exp_down[j], sep="")
...
for(i in 1:length(immediate_exptype)) {
    ...
    if(length(current_exp_up) == length(current_exp_down)) {
        for(j in 1:length(current_exp_up)) {
            current_file_path_up <- paste('/data/timonaj/cancer_as_wound/immediate_genes/', current_exp_up[j], sep="")
            current_file_path_down <- paste('/data/timonaj/cancer_as_wound/immediate_genes/', current_exp_down[j], sep="")
